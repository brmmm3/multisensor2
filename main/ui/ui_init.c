...
lv_obj_t *add_page_air(ui_t *ui)
{
    ...
    ui->lbl_s11 = add_section_label(tab, 0, 42, 72, "S11");
    ui->lbl_scd30 = add_section_label(tab, 40, 42, 72, "SCD30");
    ui->lbl_scd41 = add_section_label(tab, 80, 42, 72, "SCD41");
    ui->lbl_mhz19 = add_section_label(tab, 120, 26, 72, "MHZ19");
    ui->lbl_bmx280lo = add_section_label(tab, 144, 42, 72, "BME280L");
    ui->lbl_bmx280hi = add_section_label(tab, 184, 42, 72, "BME280H");
    ui->lbl_yys = add_section_label(tab, 224, 42, 72, "YYS");
    ui->lbl_ze08 = add_section_label(tab, 264, 26, 72, "ZE08");
    return tab;
}
...
lv_obj_t *add_page_dust(ui_t *ui)
{
    ...
    ui->lbl_sps30_1 = add_section_label(tab, 0, 26, 80, "PM0.5");
    ui->lbl_sps30_2 = add_section_label(tab, 28, 26, 80, "PM1.0");
    ui->lbl_sps30_3 = add_section_label(tab, 56, 26, 80, "PM2.5");
    ui->lbl_sps30_4 = add_section_label(tab, 84, 26, 80, "PM4.0");
    ui->lbl_sps30_5 = add_section_label(tab, 112, 26, 80, "PM10.0");
    ui->lbl_sps30_6 = add_section_label(tab, 140, 26, 80, "TypPartSz");
    return tab;
}
...
lv_obj_t *add_page_gps(ui_t *ui)
{
    ...
    ui->lbl_gps_date = add_section_label_xw(tab, 0, 0, 180, 26, 64, "Date");
    ui->lbl_gps_status = add_section_label_xw(tab, 180, 0, 140, 26, 64, "Status");
    ui->lbl_gps_time = add_section_label_xw(tab, 0, 24, 180, 26, 64, "Time");
    ui->lbl_gps_data_cnt = add_section_label_xw(tab, 180, 24, 140, 26, 64, "DatCnt");
    ui->lbl_gps_lat = add_section_label_xw(tab, 0, 48, 180, 26, 64, "Lat");
    ui->lbl_gps_error_cnt = add_section_label_xw(tab, 180, 48, 140, 26, 64, "Error");
    ui->lbl_gps_lng = add_section_label(tab, 72, 26, 64, "Lng");
    ui->lbl_gps_alt = add_section_label(tab, 96, 26, 64, "Alt");
    ui->lbl_gps_speed = add_section_label(tab, 120, 26, 64, "Speed");
    ui->lbl_gps_sats = add_section_label(tab, 144, 26, 64, "Sats");
    ui->lbl_gps_pdop = add_section_label(tab, 168, 26, 64, "PDOP");
    ui->lbl_gps_hdop = add_section_label(tab, 192, 26, 64, "HDOP");
    ui->lbl_gps_vdop = add_section_label(tab, 216, 26, 64, "VDOP");
    return tab;
}
...
lv_obj_t *add_page_wifi(ui_t *ui)
{
    ...
    ui->lbl_wifi_name = add_section_label(tab, 100, 26, 64, "Network");
    ui->lbl_wifi_ip = add_section_label_xw(tab, 0, 124, 170, 26, 64, "IP");
...
lv_obj_t *add_page_sd(ui_t *ui)
{
    ...
    ui->lbl_sd_card = add_section_label(tab, 30, 26, 64, "SD-Card");
    ui->lbl_sd_free = add_section_label(tab, 54, 26, 64, "Free");
    ui->lbl_sd_used = add_section_label(tab, 78, 26, 64, "Used");
    ui->lbl_sd_files = add_section_label(tab, 102, 26, 64, "Files");
    ui->lbl_sd_fill = add_section_label(tab, 126, 26, 64, "FillLvl");
...
lv_obj_t *add_page_cfg(ui_t *ui)
{
    ...
    ui->lbl_time = add_section_label(tab, 0, 26, 72, "Time");
